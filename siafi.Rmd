...
Vamos criar a variável cpf_nome para poder vincular as tabelas ordenador_ug, ordenador_cadastro e ordenador_remuneracao.
...
```{r expostas}
expostas <- read_excel("expostas.xlsx") %>% mutate(cpf_nome = str_c(CPF, Nome_PEP))%>% filter(cpf_nome %in% ordenador$cpf_nome)
